...
class Bird(pg.sprite.Sprite):
    ...
    def __init__(self, num: int, xy: tuple[int, int]):
        ...
        img0 = pg.transform.rotozoom(pg.image.load(f"ProjExD_05_1/fig/my_tank.png"), 0, 2.0)
...
def main():
    ...
    bg_img = pg.image.load("ProjExD_05_1/fig/pg_bg.jpg")
